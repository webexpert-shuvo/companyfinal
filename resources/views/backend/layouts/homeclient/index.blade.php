                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">All Client</h4> <br>
                            <a href="{{ route('homeclient.add') }}" class="btn btn-sm btn-success">Add New Client</a>
                            @if (session('success'))
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($alldata as $data)
                                            <tr>
                                                <td>{{ $loop -> index + 1 }}</td>
                                                <td>{{ $data -> name }}</td>
                                                <td><img src="{{ URL::to('') }}/backend/assets/img/client/{{ $data -> image -> imagename}}" alt="" style="width: 100px; height:100px;"></td>
