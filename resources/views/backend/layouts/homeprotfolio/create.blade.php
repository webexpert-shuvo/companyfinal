                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('show.homeprotfolio') }}" class="btn btn-sm btn-success">Home Protfolio</a>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="{{ route('homeprotfolio.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-sm btn-success" value="Add Gallery">
                                </div>
